...
The Allrun script implements the use of the mapFields command from the 2D case to initialize the flow. We recommend to keep 1s of warm-up on the 3D case without sediment transport and bed mobility. Run for 1s before your tun on the bed mobility and sediment transport for 20s.

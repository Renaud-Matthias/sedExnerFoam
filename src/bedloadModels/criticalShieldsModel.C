...
Foam::bedloadModels::criticalShieldsModel::criticalShieldsModel
(
...
Foam::autoPtr<Foam::bedloadModels::criticalShieldsModel>
Foam::bedloadModels::criticalShieldsModel::New
(
    const dictionary& dict
)
{
...
Foam::bedloadModels::criticalShieldsModel::viscousDiameter
(
...
) const
{
    ...
    return Foam::pow(Foam::pow(nu, 2)/(g*(s-1)), 1/3);
}
